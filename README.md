This repository helps in adding border lines abd tracking a point which is continu+ous present in a 2D tree trunk video.  
...
```
You can also install by cloning this repo:
```
