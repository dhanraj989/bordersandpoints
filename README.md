...
* process_video(video_file,video_path,output_path,initial_point): This function uses farneback algorithm and outputs a tracking point which is continuously present in a 2D tree trunk video.
...
* border_lines_cap(video_file,output_path, lines_output): This function outputs borders for each frame in input video file
  video_file: list containing name of the files in the folder
